...
class _ActionGuideState extends State<ActionGuide> {
  ...
  List<List<List<String>>> statement = [
    [
      ["test"]
    ]
  ];
  ...
  late GuideDataProvider guideDataProvider =
      Provider.of<GuideDataProvider>(context, listen: false);
                            ...
                            itemBuilder: (context, index) => ListTile(
                              ...
                              onTap: () {
                                ...
                                setState(() {
                                  ...
                                  statement.clear();
                                  title =
                                      context.read<GuideDataProvider>().title;
                                  subTitle = context
                                      .read<GuideDataProvider>()
                                      .subTitle;
                                  statement = context
                                      .read<GuideDataProvider>()
                                      .statement;
                  ...
                  builder: (context, snapshot) {
                    return Expanded(
                      child: ListView.builder(
                          shrinkWrap: true,
                          itemCount:
                              context.read<GuideDataProvider>().title.length,
