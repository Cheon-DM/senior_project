                            ...
                            child: Row(
                              children: <Widget>[
                                Expanded( // 자연재난 종류
                                  ...
                                  shrinkWrap: true,
                                  itemCount: 15,
                                  itemBuilder: (cxt, index) => ExpansionTile(
                                              ...
                                              builder: (context, snap) {
                                                return Expanded(
                                                    child: ListView.builder(
                                                        ...
                                                        itemCount: context.read<GuideDataProvider>().step,
                                                        itemBuilder: (_, idx) => ListTile(
                                                              title: Text(
                                                                context.read<GuideDataProvider>().subHead[idx],
                                                                ...
                                                                showDialog(
                                                                    ...
                                                                    builder: (BuildContext context) {
                                                                      return FutureBuilder(
                                                                          future: guideDataProvider.getNationalGuide(index),
                                                                          builder: (context, snap) {
                                                                            return AlertDialog(
                                                                              scrollable: true,
                                                                              content: Column(
